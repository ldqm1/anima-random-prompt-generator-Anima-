...
CATEGORY_MAPPINGS: dict[tuple[str, str], str] = {
    ...
    ("画面", "简单模糊背景"): "scene_environment",
    ("画面", "纯色背景"): "scene_environment",
    ("画面", "渐变多彩背景"): "scene_environment",
    ("画面", "图案背景"): "scene_environment",
    ("画面", "主题元素背景"): "scene_environment",
    ("画面", "实景背景"): "scene_environment",
    ("画面", "特效氛围背景"): "scene_environment",
